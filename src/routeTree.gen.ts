...
import { Route as MediaInfosImport } from './pages/media-infos'
...
const MediaInfosRoute = MediaInfosImport.update({
  path: '/media-infos',
  getParentRoute: () => rootRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/media-infos': {
      id: '/media-infos'
      path: '/media-infos'
      fullPath: '/media-infos'
      preLoaderRoute: typeof MediaInfosImport
      parentRoute: typeof rootRoute
    }
    '/movies': {
      id: '/movies'
...
export interface FileRoutesByFullPath {
  ...
  '/media-infos': typeof MediaInfosRoute
...
export interface RootRouteChildren {
  ...
  MediaInfosRoute: typeof MediaInfosRoute
...
const rootRouteChildren: RootRouteChildren = {
  ...
  MediaInfosRoute: MediaInfosRoute,
